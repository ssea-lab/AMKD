...
command = "python train_amkd_supervised.py --model_t={} --model_s={} --gpu=0 --use_label_smoothing --pre_train --use_class_weight --batch_size=16 --epochs=35 --cam_type=eigen_cam "
