...
command = "python train_amkd_supervised.py --model_t={} --model_s={} --gpu=0 --use_label_smoothing --pre_train --use_class_weight --batch_size=24 "
...
# test_command = "python test.py --model_t={} --model_s={} --test_file={} --gpu=0 --use_label_smoothing --cam_type=eigen_cam"
# for model_t in ['resnet18', 'convnext_pico']:
#     for model_s in t_s_dict[model_t]:
